...
export default function LibraryPage() {
  return (
    <div className="min-h-screen bg-white text-black pt-24 px-4 pb-12 selection:bg-[#C5A059]/30 selection:text-black font-sans relative overflow-x-hidden">
      {/* Background Glows */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight mb-4  leading-none">
              The <span className="text-[#C5A059]">Blueprints</span>
            </h1>
          ...
          <a href="#dictionary" className="px-6 py-3 bg-black/5 border border-black/10 rounded-xl text-xs font-black tracking-widest uppercase hover:bg-black/10 transition-all flex items-center gap-2">
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-6">
                  ...
                  <TrendingUp className="w-4 h-4 text-gray-700 group-hover:text-[#C5A059] transition-colors" />
                </div>
        ...
        {/* Dictionary Section */}
        <div id="dictionary" className="pt-24 border-t border-black/5">
          <h2 className="text-3xl font-serif font-bold tracking-tight mb-12  text-center">
            The Flipping <span className="text-[#C5A059]">Dictionary</span>
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16">
            {dictionary.map((item, i) => (
              <div key={i} className="group border-l-2 border-black/5 hover:border-[#C5A059] pl-6 transition-colors">
                ...
                {item.secondary && (
                  <div className="mt-4 inline-flex text-[9px] font-black bg-black/5 px-2 py-0.5 rounded uppercase tracking-widest text-gray-600">
        ...
        {/* Final CTA */}
        <div className="mt-32 p-12 rounded-[40px] bg-gradient-to-br from-[#C5A059]/20 via-transparent to-transparent border border-[#C5A059]/20 text-center relative overflow-hidden">
          <Palmtree className="w-64 h-64 text-[#C5A059]/5 absolute -bottom-20 -right-20 transform rotate-12" />
          <div className="relative z-10">
            <h2 className="text-4xl font-serif font-bold tracking-tight mb-6 ">Ready for retirement?</h2>
            ...
            <Link href="/#join" className="inline-flex px-10 py-5 bg-[#C5A059] text-black font-black text-lg rounded-2xl hover:shadow-[0_0_40px_rgba(255,215,0,0.4)] transition-all">
              Join the Network
            </Link>
          </div>
        </div>
